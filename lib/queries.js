...
async function getSchoolById(id) {
    ...
    try {
        ...
        console.error(`[Queries] Error in getSchoolById(${id}):`, err);
        return null;
    }
}
...
async function getSchoolsByTaluk(taluk) {
    ...
    try {
        ...
        console.error(`[Queries] Error in getSchoolsByTaluk(${taluk}):`, err);
        return [];
    }
}
...
async function getSchoolsByType(type) {
    ...
    try {
        ...
        console.error(`[Queries] Error in getSchoolsByType(${type}):`, err);
        return [];
    }
}
...
async function getSchoolsByBoard(board) {
    ...
    try {
        ...
        console.error(`[Queries] Error in getSchoolsByBoard(${board}):`, err);
        return [];
    }
}
...
async function searchSchools(query) {
    ...
    try {
        ...
        console.error(`[Queries] Error in searchSchools(${query}):`, err);
        return [];
    }
}
...
async function getNearbySchools(lat, lng, excludeId, limit = 4) {
    ...
    try {
        ...
        console.error("[Queries] Error in getNearbySchools:", err);
        return [];
    }
}
...
async function deleteSchool(id) {
    ...
    try {
        ...
        console.error(`[Queries] Error in deleteSchool(${id}):`, err);
        throw err;
    }
}
...
async function approveSchool(id) {
    ...
    try {
        ...
        console.error(`[Queries] Error in approveSchool(${id}):`, err);
        throw err;
    }
}
...
async function getPendingSchools() {
    ...
    try {
        ...
        console.error("[Queries] Error in getPendingSchools:", err);
        return [];
    }
}
...
async function getAllSchoolsForMap() {
    ...
    try {
        ...
        console.error("[Queries] Error in getAllSchoolsForMap:", err);
        return [];
    }
}
...
async function getDistinctValues(column) {
    ...
    try {
        ...
        console.error(`[Queries] Error in getDistinctValues(${column}):`, err);
        return [];
    }
}
...
async function createContact(data) {
    ...
    try {
        ...
        console.error("[Queries] Error in createContact:", err);
        throw err;
    }
}
...
async function getAllAdminSchools() {
    ...
    try {
        ...
        console.error("[Queries] Error in getAllAdminSchools:", err);
        return [];
    }
}
